...
let shareCodes = [ // IOS本地脚本用户这个列表填入你要助力的好友的shareCode
  ...
  'MTE1NDY3NTMwMDAwMDAwNDk5MjI3MDE=@MTEyNjE4NjQ2MDAwMDAwMDQ5OTIyNjY3@MTE1MzEzNjI2MDAwMDAwMDQ5OTIyNzM5@MTEyNjE4NjQ2MDAwMDAwMDUwODI1MjYx@MTE1NDQ5MzYwMDAwMDAwMzgxNjkyMzM=@MTEzMzI1MTE4NDAwMDAwMDA1MTIzODkyNw==',
...
function requireConfig() {
  return new Promise(resolve => {
    ...
    const jdPetShareCodes = $.isNode() ? require('./function/jdPetShareCodes.js') : '';
...
//     headers: {
//       Cookie: cookie,
//       UserAgent: $.isNode() ? (process.env.JD_USER_AGENT ? process.env.JD_USER_AGENT : (require('./function/USER_AGENTS').USER_AGENT)) : ($.getdata('JDUA') ? $.getdata('JDUA') : "jdapp;iPhone;9.4.4;14.3;network/4g;Mozilla/5.0 (iPhone; CPU iPhone OS 14_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1"),
//     }
//   };
// }
function taskUrl(function_id, body = {}) {
      ...
      try {
        if (err) {
          ...
          if (
            ...
            console.log(`【京东账号${$.index}（${$.UserName}）京东萌宠互助码】${$.petInfo.shareCode}`);
            shareCodesdq += $.petInfo.shareCode + "@"
