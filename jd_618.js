...
[task_local]
#618红包
0 0 0,12,19,20 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_618red.js, tag=618红包, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_bean_home.png, enabled=true

================Loon==============
[Script]
cron "0 0 0,12,19,20 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_618red.js, tag=618红包

===============Surge=================
618红包 = type=cron,cronexp="0 0 0,12,19,20 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_618red.js

============小火箭=========
618红包 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_618red.js, cronexpr="0 0 0,12,19,20 * * *", timeout=3600, enable=true
 */
const $ = new Env('618红包');
const jdCookieNode = $.isNode() ? require('./jdCookie.js') : '';
let rebateCodes = 'Oq72ACf'
...
let shareCodeArr = {}
$.runArr = {}
const activeEndTime = '2023/06/18 00:00:00+08:00';//活动结束时间
...
async function run(type = 0){
    try{
        ...
        let t = 0
        do{
            const flCodeArr = ["Oq72ACf","Oz72k0j","Os72lTs","Ou7usp5","Oz7iRRw","ObJUbCL"];
            ...
            await getUrl1()
            $.actId = $.url2.match(/mall\/active\/([^/]+)\/index\.html/) && $.url2.match(/mall\/active\/([^/]+)\/index\.html/)[1] || `https://prodev.m.jd.com/mall/active/3nNmntNrufZjkZF1XJJKknDuCbaQ/index.html?unionActId=31162&d=${rebateCode}`
...
function getCoupons(shareId = '',type = 1) {
    return new Promise(async resolve => {
        await requestAlgo();
        let time = Date.now()
        let body = {"platform": 2,"unionActId": "31162","actId": $.actId,"d": rebateCode,"unionShareId": shareId, "type": type,"eid": "-1"}
...
function showCoupon(shareId = '') {
    ...
    return new Promise(resolve => {
        let opts = {
            url: `https://api.m.jd.com/api?functionId=showCoupon&appid=u&_=${Date.now()}&loginType=2&body={%22actId%22:%22${$.actId}%22,%22unionActId%22:%2231162%22,%22unpl%22:%22%22,%22platform%22:4,%22unionShareId%22:%22%22,%22uiUpdateTime%22:1641456650000,%22d%22:%22${rebateCode}%22,%22eid%22:%22${$.eid}%22}&client=apple&clientVersion=8.3.6`,
            headers: {
                "Accept-Language": "zh-cn",
                "Accept-Encoding": "gzip, deflate, br",
                'Cookie': `${newCookie} ${cookie}`,
...
function shareUnionCoupon() {
    ...
    return new Promise(resolve => {
        let opts = {
            url: `https://api.m.jd.com/api?functionId=shareUnionCoupon&appid=u&_=${Date.now()}&loginType=2&body={%22unionActId%22:%2231162%22,%22actId%22:%22${$.actId}%22,%22platform%22:4,%22unionShareId%22:%22${$.shareCode}%22,%22d%22:%22${rebateCode}%22,%22supportPic%22:2,%22supportLuckyCode%22:0,%22eid%22:%22${$.eid}%22}&client=apple&clientVersion=8.3.6`,
            headers: {
                "Accept-Language": "zh-cn",
                "Accept-Encoding": "gzip, deflate, br",
                'Cookie': `${newCookie} ${cookie}`,
